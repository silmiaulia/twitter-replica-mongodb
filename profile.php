                    ...
                    <section class="w-3/5 border border-y-0 border-gray-200" style="max-width:600px;">
                        ...
                        <div>
                            <div class="flex justify-start">
                                ...
                                <div class="mx-2">
                                    <h2 class="mb-0 text-xl font-bold text-gray-900">sunoo</h2>
                        ...
                        <div>
                            ...
                            <div class="p-4">
                                ...
                                <div class="space-y-1 justify-center w-full mt-3 ml-3">
                                    ...
                                    <div class="mt-3">
                                        <p class="text-gray-900 leading-tight mb-2">Software Engineer / Designer / Entrepreneur <br>Visit my website to test a working <b>Twitter Clone.</b> </p>
                        ...
                        <li>
                             ...
                             <article class="hover:bg-gray-200 transition duration-350 ease-in-out">
                                                ...
                                                <div class="ml-3">
                                                    ...
                                                    <?php echo "{$item['username']}"; ?>
                                                        <span class="text-sm leading-5 font-normal text-gray-500 group-hover:text-gray-600 transition ease-in-out duration-150">
                                                           <?php echo "{$item['email']}"; ?>  <span>&#183;</span> 2h
                                                        </span>
                                                    </p>
                                                </div>
                                            </div>
                                    ...
                                    <div class="pl-16">
                                        <p class="text-base width-auto font-normal text-black flex-shrink">
                                            ceritanya ini ada tweet <a href="#" class="text-blue-400">#hashtag</a>. 
                                            Hashtagnya berubah jadi warna biruu, baguss kan <a href="#" class="text-blue-400">#keren</a>
                                        </p>
                            ...
                            <li>
                                ...
                                <article class="hover:bg-gray-200 transition duration-350 ease-in-out">
                                    <div class="flex flex-shrink-0 p-4 pb-0">
                                        <a href="#" class="flex-shrink-0 group block">
                                            <div class="flex items-center">
                                                ...
                                                <div class="ml-3">
                                                    <p class="text-base leading-6 font-medium text-grey-900">
                                                        <?php echo "{$item['username']}"; ?>
                                                        <span class="text-sm leading-5 font-normal text-gray-500 group-hover:text-gray-600 transition ease-in-out duration-150">
                                                           <?php echo "{$item['email']}"; ?>  <span>&#183;</span> 2h
                                                        </span>
                                    ...
                                    <div class="pl-16">
                                        <p class="text-base width-auto font-normal text-black flex-shrink">
                                            Sekarang udah jam 03.32 gaess, ngantuk bangett <a href="#" class="text-blue-400">#begadang</a>
                                        </p>
                        ...
                        <div style="max-width:350px;">
                            <div class="overflow-y-auto fixed  h-screen">
                                ...
                                <div class="max-w-sm rounded-lg  bg-gray-50 overflow-hidden shadow-lg m-4 mt-8">
                                    <div class="flex">
                                        <div class="flex-1 m-2">
                                            <h2 class="px-4 py-4 text-xl w-48 font-bold text-black">Who to follow</h2>
                                        </div>
                                    </div>
                                    ...
                                    <div class="flex flex-shrink-0">
                                        ...
                                        <div class="flex-1 px-4 py-2 m-2">
                                            <a href="" class=" float-right">
                                                <button class="bg-black hover:bg-gray-800 text-white font-semibold hover:text-white py-2 px-4 border border-white hover:border-transparent rounded-full">
                                                    Follow
                                                </button>
                                            </a>
