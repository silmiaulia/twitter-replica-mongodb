                        ...
                        <aside>
                            ...
                            <div class="flex">
                                ...
                                <div class="flex-1 px-2 pt-2 mt-2">
                                    <textarea class="bg-transparent text-gray-500 font-small focus:outline-0 text-lg w-full" rows="2" cols="50" placeholder="What's happening?"></textarea>
                                </div>
                            </div>
                            ...
                            <div class="flex">
                                ...
                                <div class="flex-1">
                                    <button class="bg-blue-500 hover:bg-blue-600 mt-5 text-white font-bold py-2 px-8 rounded-full mr-8 float-right">
                                        Tweet
                                    </button>
                                </div>
                            </div>
                                                ...
                                                <div class="ml-3">
                                                    <p class="text-base leading-6 font-medium text-gray-900">
                                                        ...
                                                        <span class="text-sm leading-5 font-normal text-gray-500 group-hover:text-gray-600 transition ease-in-out duration-150">
                                                            @<?php echo $username; ?>  <span>&#183;</span> 2h
                                                        </span>
                                                    </p>
                                                </div>
                                            </div>
